...
def sistema():
    ...
    msgEntrada.place(relx=0.4, rely=0.45)
    ...
    def tela_documentos():
        ...
        frame_pedidos.place(relx=0.002, rely=0.2, relwidth = 0.85, relheight= 0.75)
    ...
    def tela_registrar_horarios():
        ...
        frame_tabela.place(relx=0.15, rely=0.25, relwidth=0.55, relheight=0.6)
        ...
        btn_salvar = ctk.CTkButton(
            ...
            font=("Arial", 14, "bold"),
            corner_radius=8,
            command=salvar_horario
        )
        btn_salvar.place(relx=0.62, rely=0.86)
    ...
    def tela_registrar_boletins():
        ...
        btn_salvar.place(relx=0.44, rely=0.72)
        ...
        btn_imprimir.place(relx=0.52, rely=0.72)
    ...
    def tela_registrar_cardapio():
        ...
        def criar_tabela():
            ...
            horarios = ["6:30", "9:20", "12:20", "14:30"]
            # Cabeçalho 
            ...
            ctk.CTkLabel(
                ...
                corner_radius=5,
                fg_color=COLOR_SECONDARY,
                text_color="white").grid(row=0, column=0, padx=15, pady=10)
            ...
            for col, dia in enumerate(dias_semana):
                ...
                header.grid(row=0, column=col+1, padx=5, pady=10)
            ...
            for row, horario in enumerate(horarios, start=1):
                ...
                for col in range(len(dias_semana)):
                    ...
                    refeicoes.append(linha_entries)

        criar_tabela()  # Gera a tabela na tela

        def salvar_dados_cardapio():
            import sqlite3

            connect = sqlite3.connect('Banco_sistema.db')
            messagebox.showinfo("Sucesso","Cardapio salvo com sucesso!!")
            

        # Botão pra salvar os dados
        btn_salvar = ctk.CTkButton(
            master=frame_conteudo,
            text="SALVAR HORÁRIOS",
            width=150,
            ...
            font=("Arial", 14, "bold"),
            corner_radius=8,
            command=salvar_dados_cardapio
        )
        btn_salvar.place(relx=0.55, rely=0.52)
